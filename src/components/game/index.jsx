        ...
        <>
            ...
            <div className={styles.content}>
                <div className={styles.box}>
                    ...
                    <input type={'text'} value={time1 || ''} onChange={(evt) => setTime1(evt.target.value)}></input>
                </div>
                <div className={styles.text}>X</div>
                <div className={styles.box}>
                    <input type={'text'} value={time2 || ''} onChange={(evt) => setTime2(evt.target.value)}></input>
                    <img src={Flags.converterFlag(match.time2.nome)} className={styles.icon}></img>
                </div>
            </div>
            <button onClick={save}>Salvar aposta</button>
        </>
    )
}
